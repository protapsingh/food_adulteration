...
<li class="active"><a href="resolvedlisthtml.php">Solved Complaint</a></li>
...
<!--main work-->
  <div class="main" style="color:#BAD6F2; padding-left:160px;">
 <h3 style="color:white; padding-left: 210px;">Solved Complaint List</h3>  
